...
How It Runs
Environment Setup: Install dependencies using pip install pandas sqlalchemy psycopg2.

Data Processing: Run the Jupyter Notebook (app.ipynb) to clean the data and trigger the SQL export.

Database: Ensure PostgreSQL is running; the script will automatically create and populate the customer table.

Visualization: Open the .pbix file in Power BI and refresh the data source to view the latest insights.
